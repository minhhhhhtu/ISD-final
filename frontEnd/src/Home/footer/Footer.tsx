                ...
                <div className="flex flex-col md:flex-row text-center md:text-left gap-12 md:gap-8">
                    ...
                    <div className="basis-1/6">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">HOME</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">PRODUCTS</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">BLOG</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">ABOUT</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">CONTACT</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">STYLEGUIDE</a></div>
                        </div>
                    </div>
                    <div className="basis-1/6">
                        <div className="uppercase font-semibold tracking-wider text-pinky-600 mb-4">Follow us</div>
                        <div className="flex flex-col gap-3">
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">Facebook</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">Instagram</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">Pinterest</a></div>
                            <div className=""> <a href="#" className="text-pinky-600 hover:text-slate-600">Twitter</a></div>
                        </div>
                    </div>
                    <div className="basis-2/6">
